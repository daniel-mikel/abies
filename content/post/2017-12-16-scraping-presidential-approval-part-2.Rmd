...
server <- function(input, output){
  ...
  output$pres_plot <- renderPlot({
    tidy_pres %>%
      ...
      ggplot(aes(x = as.Date(end_date, format = "%Y-%m-%d"), y = percent, col = opinion)) +
