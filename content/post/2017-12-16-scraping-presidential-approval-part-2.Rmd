...
For some reason running geom_smooth(method = "gam") was tripping an error when publishing on the shiny server. I ended up just switching to a loess function, but I wasn't happy that I couldn't find a direct fix. When I went to publish the this post through blogdown geom_smooth() wasn't rendering with the rest of the plot. 
